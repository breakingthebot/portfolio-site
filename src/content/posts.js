...
const POSTS = [
  {
    ...
    date: "2026-07-07",
    excerpt:
      "For 28 years before I touched an AI tool, my job was the same thing over and over: get dropped into a system nobody trained me on, and figure out how to automate the part that was eating everyone's time.",
    body: [
      "For 28 years before I touched an AI tool, my job was the same thing over and over: get dropped into a system nobody fully trained me on, figure out how the pieces actually connect underneath, and build something to automate the part that was eating everyone's time.",
      ...
      "AI-286-Builds is 286 small projects across as many languages, tools, and problem types as I can manage, each one logged: what I built, why, what broke, what I'd do differently. It's not because I need to prove I can build things — I've been doing that for 28 years. It's because I've never had a public trail of it before, and breadth-first is how I've always actually learned: touch enough different systems that the patterns underneath them start showing themselves, then decide what's worth going deep on.",
